...
class PositionInstance extends StoredEntity implements PositionContent {
    ...
    const POSITIONINSTANCE_ORDER_RANDOM = 'POSITIONINSTANCE_ORDER_RANDOM';
    const POSITIONINSTANCE_ORDER_OBJECTNAME_ASC = 'POSITIONINSTANCE_ORDER_OBJECTNAME_ASC';
    const POSITIONINSTANCE_ORDER_OBJECTNAME_DESC = 'POSITIONINSTANCE_ORDER_OBJECTNAME_DESC';
