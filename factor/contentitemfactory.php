                            ...
                            if (Validator::isNumeric(current($matches))) {
                                ...
                                try {
                                    ...
                                    if (Authorization::getObjectPermission($object, Authorization::OBJECT_VIEW)) {
                                        ...
                                        $replacement = str_replace(Terms::POSITION_REFERRAL, CommandFactory::getObject($object, $this->getMode(), $this->getContext()), $replacement);
                                        $replacement = str_replace(Terms::POSITION_REFERRAL_URL, $object->getBaseSEOURL($this->getMode()), $replacement);
                                        $line = str_replace("[" . $objectid . "|", $replacement, $line);
                                    } else {
