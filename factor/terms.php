...
class Terms {
    ...
    const CONTENT_METADATA = '#metadata#'; // insert metadata starting with the site root here in a snippet 
    const CONTENT_SITEMAP = '#sitemap#'; // insert metadata starting with the site root here in a snippet 
    ...
    const OBJECT_ROOT_CREATOR = '#creator#'; // the user that created this object (and the root object for this object)
    const OBJECT_ROOT_EDITOR = '#editor#'; // the user that last changed the root object for this object
    ...
    const OBJECT_DEEP_LINK_FULL = '#deeplinkfull#'; // the deep link with the site root to this object (only for instanciable objects)
    const OBJECT_DEEP_LINK_COMMAND = '#deeplinkcommand#'; // the ajax command for deep linking to this object
    const OBJECT_SITE_ROOT = '#siteroot#'; // insert site root 
    const OBJECT_SITE_ROOT_FOLDER = '#siterootfolder#'; // insert site root folder (sub folder)
    const CLASS_SUFFIX = '#c#'; // the suffix that defines the css class to use for the current context
    const POSITION_SITE_ROOT = '#siteroot#'; // insert site root 
    const POSITION_SITE_ROOT_FOLDER = '#siterootfolder#'; // insert site root folder (sub folder)
